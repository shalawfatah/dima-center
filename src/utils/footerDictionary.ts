export const footerDictionary: Record<'en' | 'ar' | 'ckb', FooterTranslations> = {
  en: {
    ...
    aboutDesc: 'Your premium destination for advanced computer hardware setups and gaming.',
  ...
  ckb: {
    ...
    aboutDesc: 'سەنتەری دابینکردنی باشترین پارچەی کۆمپیوتەر و گەیمینگ.',
